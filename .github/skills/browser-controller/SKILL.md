...
2. 実行:
   ...
   - 実行方法:
     - `cd .github/skills/browser-controller/scripts && python browser_controller.py <command>`
     - `python .github/skills/browser-controller/scripts/browser_controller.py <command>`
