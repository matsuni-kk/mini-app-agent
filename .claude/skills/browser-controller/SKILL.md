...
2. 実行:
   ...
   - 実行方法:
     - `cd .claude/skills/browser-controller/scripts && python browser_controller.py <command>`
     - `python .claude/skills/browser-controller/scripts/browser_controller.py <command>`
