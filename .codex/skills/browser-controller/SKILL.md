...
2. 実行:
   ...
   - 実行方法:
     - `cd .codex/skills/browser-controller/scripts && python browser_controller.py <command>`
     - `python .codex/skills/browser-controller/scripts/browser_controller.py <command>`
