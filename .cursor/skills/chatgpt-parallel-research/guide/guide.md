...
```
.cursor/skills/chatgpt-parallel-research/
├── SKILL.md                   ← Skill定義
├── guide/
│   └── guide.md               ← この仕様書
├── scripts/
...
cd .cursor/skills/chatgpt-parallel-research/scripts
...
# Chrome拡張の接続確認
python .cursor/skills/chatgpt-parallel-research/scripts/chatgpt_multi.py status
```
